  ...
  <section className="section-padding">
    <div className="container">
      <div className="row">
        ...
        {/*3 Column */}
        <div className="col-md-4 gallery-item">
          <a href="img/images/Family Suite Edited/4.webp" title="" className="img-zoom">
            <div className="gallery-box">
              <div className="gallery-img">
                {" "}
                <img
                  src="img/images/Family Suite Edited/4.webp"
                  className="img-fluid mx-auto d-block"
                  alt="work-img"
                />{" "}
              </div>
        ...
        <div className="col-md-4 gallery-item">
          <a href="img/images/Business class edited/jpeg-optimizer_IMG_3107.JPG" title="" className="img-zoom">
            <div className="gallery-box">
              <div className="gallery-img">
                {" "}
                <img
                  src="img/images/Business class edited/jpeg-optimizer_IMG_3107.JPG"
                  className="img-fluid mx-auto d-block"
                  alt="work-img"
                />{" "}
              </div>
        ...
        <div className="col-md-4 gallery-item">
          <a href="img/images/restaurant/2-Copy.png" title="" className="img-zoom">
            <div className="gallery-box">
              <div className="gallery-img">
                {" "}
                <img
