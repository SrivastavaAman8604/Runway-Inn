...
function Conscious() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://www.earthyhues.com/admin/api-conscious-travel');
          ...
          <div className="sidebar-blog sidebar-blog--left">
            <aside className="widget-area">
              ...
              >
                ...
                <a href="https://www.earthyhues.com/admin/sites/all/themes/bootstrap/HT feature1.jpg" className="comment-box__btn trevlo-btn trevlo-btn--white-two"><span className='px-5'>View my Article
                </span></a>
                <a href="https://www.earthyhues.com/admin/sites/all/themes/bootstrap/HT feature.jpeg" className="comment-box__btn trevlo-btn trevlo-btn--white-two mt-3"><span className='px-5'>View whole Page</span></a>
